...
#define SUR_TEMP_PIN A1 // Analog input pin connect to temperature sensor SUR pin
#define OBJ_TEMP_PIN A2 // Analog input pin connect to temperature sensor OBJ pin
